...
model = backend_model()
third_party_path = os.path.normpath('Back_End/fast_models/third_party_model/third_party_model')
location_path = os.path.normpath('Back_End/fast_models/location_model/location_model')
identifier_path = os.path.normpath('Back_End/fast_models/identifier_model/Best_Identifier_Model')
contacts_path = os.path.normpath('Back_End/fast_models/contact_model/CONTACT')
